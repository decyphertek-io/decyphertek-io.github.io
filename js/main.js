...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const I18N = {
        ...
        'stk.githubTitle': { en: 'StackTek Documentation', es: 'Documentación de StackTek' },
        'stk.githubText': { en: 'What StackTek does, what you need, and how to run it — features, requirements, install, and updates.', es: 'Qué hace StackTek, qué necesitas y cómo ejecutarlo: funciones, requisitos, instalación y actualizaciones.' },
